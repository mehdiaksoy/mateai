...
exports.DatabaseConfigSchema = zod_1.z.object({
    ...
    connectionTimeout: zod_1.z.number().int().positive().default(30000), // 30s
});
/**
 * Redis Configuration
 */
exports.RedisConfigSchema = zod_1.z.object({
    ...
    maxRetriesPerRequest: zod_1.z.number().int().positive().nullable().default(null), // null for BullMQ
});
/**
...
exports.EmbeddingConfigSchema = zod_1.z.object({
    ...
    batchSize: zod_1.z.number().int().positive().default(100), // Process embeddings in batches
});
/**
...
exports.ApiConfigSchema = zod_1.z.object({
    ...
    rateLimit: zod_1.z.object({
        windowMs: zod_1.z.number().int().positive().default(15 * 60 * 1000), // 15 minutes
        max: zod_1.z.number().int().positive().default(100), // 100 requests per window
    }).optional(),
});
/**
